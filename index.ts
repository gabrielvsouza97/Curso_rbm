...
const somaDoisNumeros = (numero1: number, numero2: number) => numero1 + numero2;
...
const mediaCincoNumeros = (numeros:Array<number>) => {
    let somaNumeros = 0;
...
const numerosParaSomar:Array<number> = [5,12,17,14,34]; 

console.log(mediaCincoNumeros(numerosParaSomar));
//Calculo de IMC

const calculadoraImc = (peso:number, altura:number)=> {
    const elvQuadrado = 2;
